...
class Analyse:
    """[summary]
    """
    def __init__(self, data, period_beg, period_end, relev):
        """[summary]
    ...
    def find_new_observations(self):
        """[summary]
        """
        increase = Increase(self.data, self.period_begin, self.period_end, self.relev_table)
        increase.analyse()
        self.observations.extend(increase.observations)

        decrease = Decrease(self.data, self.period_begin, self.period_end, self.relev_table)
        decrease.analyse()
