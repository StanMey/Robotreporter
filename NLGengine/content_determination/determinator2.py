...
class Determinator2:
    ...
    def load_model(self):
        ...
        """
        model_path = r"./NLGengine/content_determination/deter_model.json"
        weights_path = r"./NLGengine/content_determination/deter_model.h5"
    ...
    def one_hot_encode_input(self, obs1, obs2):
    ...
    def get_follow_up_weight(self, observ, new_observ):
        ...
        combi_encoded = self.one_hot_encode_input(observ, new_observ)
